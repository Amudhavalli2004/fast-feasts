...
const CartPage = () => {
  ...
  return (
    <div className="h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)] flex flex-col text-red-500 lg:flex-row ">
      {/* PRODUCTS CONTAINER */}
      <div className="h-1/2 p-4 flex flex-col justify-center overflow-scroll hide-scrollbar lg:h-full lg:w-2/3 2xl:w-1/2 lg:px-20 2xl:px-40">
        {/* SINGLE ITEM */}
        {products.map((item) => (
      ...
      <div className="h-1/2 p-4 bg-fuchsia-50 flex flex-col gap-4 justify-center lg:h-full lg:w-1/3 2xl:w-1/2 lg:px-20 2xl:px-40 2xl:text-xl 2xl:gap-6">
        ...
        <div className="flex gap-3 justify-between ">
          <button
            className="bg-red-500 text-white p-3 rounded-md w-1/3"
            onClick={clearCart}
          >
            CLEAR CART
          </button>
